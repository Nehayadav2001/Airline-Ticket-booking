    ...
    public partial class admin : System.Web.UI.Page
    {
        ...
        private void GetFlightDetails()
        {
            ...
            catch (Exception ex)
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Error", "alert('An error occurred while retrieving flight data. Please try again later.')", true);
            }
        }
        ...
        protected void getdata_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                string errorMessage = "Error: " + ex.ToString();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Error", "alert('An error occurred while Deleting flight data. Please try again later.')", true);
            }
        ...
        protected void empgrid_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                string errorMessage = "Error: " + ex.ToString();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Error", "alert('An error occurred while Updating flight data. Please try again later.')", true);
            }
        ...
        protected void Emp_dropdowns(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                string errorMessage = "Error: " + ex.ToString();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Error", "alert('An error occurred while Binding flight data. Please try again later.')", true);
            }
